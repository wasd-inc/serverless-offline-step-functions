    ...
    whatToRun(stateInfo, input, outputKey, callback) {
        switch(stateInfo.Type) {
            case 'Task':
                ...
                // const context = ;
                let runner = `const context = require('${path.relative(process.cwd(), path.resolve(__dirname, './create-lambda-context'))}')(require('${this.getWebpackOrCommonFuction(handlerSplit[0])}').${handlerSplit[1]}, ${callback}); `;
